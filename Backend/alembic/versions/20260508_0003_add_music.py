...
def upgrade() -> None:
    ...
    op.create_index("ix_music_tracks_title", "music_tracks", ["title"])
    op.create_index("ix_music_tracks_pinned", "music_tracks", ["pinned"])
    op.create_index("ix_music_tracks_owner_id", "music_tracks", ["owner_id"])
    op.create_index("ix_music_tracks_pinned_updated", "music_tracks", ["pinned", "updated_at"])
